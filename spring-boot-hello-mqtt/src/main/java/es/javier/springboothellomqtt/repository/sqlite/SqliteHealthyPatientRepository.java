...
public class SqliteHealthyPatientRepository implements PatientRepository {
    ...
    public void saveTemperature(float temperature) {
        final HealthyTemperatureMeasurementEntity entity = new HealthyTemperatureMeasurementEntity(temperature);
    ...
    public List<TemperatureMeasurement> readAllTemperatures() {
            final Query query = entityManager.createQuery("SELECT e from HealthyTemperatureMeasurementEntity e");
